...
class SubscriptionController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $oldSubscription = Subscription::LastSubscription($business_id);
        ...
        return view('superadmin::subscription.index',['oldSubscription'=>$oldSubscription])
            ->with(compact('userlist','packages', 'active', 'nexts', 'waiting', 'permission_formatted'));
    }
    ...
    public function ShowSubscriptionList() {
        ...
        return view('superadmin::subscription.showSubscriptionList');
    }
