...
<!-- Add emi & bkash Part -->
<div class="payment_details_div @if( $payment_line['method'] !== 'emi' ) {{ 'hide' }} @endif" data-type="emi" >
	<div class="col-md-6">
		<div class="form-group">
			{!! Form::label("name_$row_index",'Deposit Name') !!}
			{!! Form::text("payment[$row_index][depositor_name]", $payment_line['depositor_name'], ['class' => 'form-control', 'placeholder' =>'Depositor Name', 'id' => "depositor_name_$row_index"]); !!}
		</div>
	</div>
        <div class="col-md-6">
		<div class="form-group">
			{!! Form::label("emi_no_$row_index",'EMI No') !!}
			{!! Form::text("payment[$row_index][emi_no]", $payment_line['emi_no'], ['class' => 'form-control', 'placeholder' =>'Emi No', 'id' => "emi_no_$row_index"]); !!}
		</div>
	</div>
</div>
<div class="payment_details_div @if( $payment_line['method'] !== 'bkash' ) {{ 'hide' }} @endif" data-type="bkash" >
	<div class="col-md-6">
		<div class="form-group">
			{!! Form::label("phone_no_$row_index",'Phone Number') !!}
			{!! Form::text("payment[$row_index][phone_number]", $payment_line['phone_number'], ['class' => 'form-control', 'placeholder' =>'Phone Number', 'id' => "phone_number_$row_index"]); !!}
		</div>
	</div>        
</div>
