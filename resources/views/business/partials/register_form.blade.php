...
<div class="col-md-6">
    ...
    <div class="input-group">
        ...
        {!! Form::select('currency_id', $currencies, '134', ['class' => 'form-control select2_register','placeholder' => __('business.currency_placeholder'), 'required']); !!}
    </div>
    </div>
</div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <div>
            use only hisabe.net email or contact with us
        </div>
    </div>
</div>
<div class="clearfix"></div>
