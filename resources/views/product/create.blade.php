  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <select name="productType" class="form-control" required>
                <option value="0" selected>Others Product</option>
                <option value="1">Vehicle</option>
            </select>
          </div>
        </div>
        <!-- Custom field add buttons-->
        ...
        <div class="clearfix"></div>
        <fieldset>
            <input type="hidden" name="customFieldCount" value="0" id="count">
        </fieldset>
        ...
        <div class="form-group" id="customblock'+i+'">\n\
            <div class="col-xs-6 col-md-6">\n\
                ...
                <select name="customField'+i+'" required class="form-control" placeholder="{{__('lang_v1.select_custom_field')}}">\n\
                    <option value="" selected>Select Custom Field</option>@foreach($custom_field as $field)<option value="{{$field->id}}">{{$field->customFieldName}}</option>@endforeach\n\
                </select>\n\
            </div>\n\
            <div class="col-xs-6 col-md-6">\n\
