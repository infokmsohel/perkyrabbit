      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="form-group">
                Current Logo : 
                @if(file_exists($invoice_layout->logo))                
                    <img src="{{asset($invoice_layout->logo)}}" width="160" height="80" Logo not found>
                @else
                    <img src="{{asset('uploads/invoice_logos/'.$invoice_layout->logo)}}" width="160" height="80" Logo not found>
                @endif
            </div>
        </div>
        <div class="col-sm-6">
