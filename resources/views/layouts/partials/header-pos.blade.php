...
<div class="col-md-12 no-print pos-header">
  <div class="row">
    ...
    <div class="col-md-10">
      ...
      <!-- custom payment -->
        <button type="button" class="btn bg-green btn-flat m-6 btn-xs m-5 btn-modal pull-right"  title="{{ __('lang_v1.custom_payment') }}" data-toggle="modal" data-target="#customPayment" >
