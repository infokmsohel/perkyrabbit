      ...
      <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text('fatherName', null, ['class' => 'form-control','placeholder' =>"Father's Name"]); !!}
            </div>
        </div>
      </div>
        ...
        <div class="col-md-4">
          <div class="form-group">
              ...
              <div class="input-group">
                  ...
                  <input type="text" name="account_opening_balance" value="0" class="form-control input_number">
              </div>
          </div>
        </div>
