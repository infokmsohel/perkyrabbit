      ...
      <div class="row">
        <div class="col-sm-12">
          <table class="table">
            ...
            <tr>
              <td>
                @lang('cash_register.previous_closing_cash'):
              </td>
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $closing_amount }}</span>
              </td>
            </tr>

            <tr>
              <td>
                @lang('cash_register.cash_forwarded'):
              </td>
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $cashForward }}</span>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $register_details->cash_in_hand+$cashForward->cash_forwarded }}</span>
              </td>
            </tr>
            ...
            <tr>
              <td>
                @lang('cash_register.credit_payment'):
              </td>
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $credit }}</span>
              </td>
            </tr>

            {{--<tr>--}}
            {{--<td>--}}
            {{--@lang('cash_register.bank_payment'):--}}
            {{--</td>--}}
            {{--<td>--}}
            {{--<span class="display_currency" data-currency_symbol="true">{{ $register_details->total_cheque }}</span>--}}
            {{--</td>--}}
            ...
            <tr class="success">
              ...
              <td>
                <b><span class="display_currency" data-currency_symbol="true">{{ ($register_details->cash_in_hand + $register_details->total_cash+$closing_amount) - ($register_details->total_cash_refund+$expenses) }}</span></b>
              </td>
            </tr>
          </table>
        </div>
