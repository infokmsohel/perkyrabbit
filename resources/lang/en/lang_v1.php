...
return [
        ...
        'add_custom_field_name' =>'Add Custom Field Name',
        ...
        //V.2.11.4 New Add
        'resend_confarmation'=>'Resend Confirmation Link ',
        'confarm_email_message'=>'A confirmation email has been sent to Check your inbox and click on the link to confirm your email address. ',
        'confarm_email'=>'Confirm your email address!',
        'transaction_not'=>'Transaction ID is Not Found',
        'transaction_info'=>'Transaction info:',
        'show_detail'=>'Show Details ',
        'input_transaction'=>'Input Transaction ID:',
        'sort_user'=>'Sort By User',
        'monthly'=>'Monthly',
        'yearly'=>'Yearly',
        'show'=>'Show all',
        'renew'=>'Renew',
        'trac_transaction'=>'Track Transaction',
        'subscription_list'=>'Subscription List',
        'half_yearly'=>'Half Yearly',
        'message'=>'Message',
        'pricing'=>'Pricing',
        "no_account"=>"Don't have an account?",
        'welcome' =>'Welcome To Hisabe!',
        'sign_in'=>'Sign In To Hisabe',
        //Version Previous
