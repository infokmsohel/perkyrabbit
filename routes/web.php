...
Route::middleware(['IsInstalled'])->group(function () {
    ...
    // Lock Session
    Route::get('user/inactive','Auth\SessionLockController@LockSession');
    Route::post('unlock/session','Auth\SessionLockController@UnlockSession');
});

Route::middleware(['IsInstalled', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    
    
    Route::get('email/not-verified','BusinessController@PendingVerificationPageShow');
    Route::get('email/verification','BusinessController@VerifyRegisterEmail');
    route::get('resend/confirmation-link','BusinessController@ResendConfirmationAgain');
...
Route::middleware(['IsInstalled', 'auth', 'SetSessionData', 'language', 'timezone','SessionLock','AccountConfirmation'])->group(function () {
    ...
    Route::post('product/add-custom-field','ProductController@AddCustomField');    
    ...
    Route::post('custom-payment','CustomPaymentController@AddPayment');
    ...
    //Reports...
    Route::get('custom/payment-history','CustomPaymentController@ShowDetails');
    Route::get('print/custom-payment/{id}','CustomPaymentController@PrintInvoice');
    ...
    // Advance Payment
    Route::get('AdvancePayment','AdvancePaymentController@ShowAdvncePaymentPage');
    Route::post('AdvancePayment','AdvancePaymentController@Store');
    Route::get('get-payment','AdvancePaymentController@view');
    Route::get('edit/advance/{id}','AdvancePaymentController@EditPayment');
    Route::get('print/advance/{id}','AdvancePaymentController@PrintInvoice');
