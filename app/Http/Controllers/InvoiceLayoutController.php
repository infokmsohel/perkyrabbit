...
class InvoiceLayoutController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $dir="uploads/business/".str_replace(' ','_',$busuiness->name).'/invoice_logo/';
            $logo_name = $this->UploadImage($request, 'logo', $dir, 320, 160, '');
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            //Upload Logo
            $busuiness = Business::find($business_id);
            $data = InvoiceLayout::where('id', $id)
                        ->where('business_id', $business_id)->first();
            $dir="uploads/business/".str_replace(' ','_',$busuiness->name).'/invoice_logo/';
            $logo_name = $this->UploadImage($request, 'logo', $dir, 320, 160,$data->logo);
