...
class BusinessLocationController extends Controller
{
     ...
     * @return void
     */
    public function __construct(Util $commonUtil, ModuleUtil $moduleUtil,AccountController $account)
    {
...
//            $this->accountController->storeAccount();
            ...
            //create account when created business location

//            $users=auth()->user()->id;
//            $newLocation=$location->id;
//            $business = session()->get('user.business_id');
//            $this->accountController->storeAccount($users,$business,$newLocation);

            $users= auth()->user()->id;
            $business = session()->get('user.business_id');

            $this->accountController->storeAccount($users,$business,$location->id,$location->name);



            //end account when created business location
