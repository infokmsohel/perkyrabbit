...
class Util
{
    ...
    {
        $payment_types = ['cash' => __('lang_v1.cash'), 'card' => __('lang_v1.card'), 'cheque' => __('lang_v1.cheque'), 'bank_transfer' => __('lang_v1.bank_transfer'),'emi'=> __('lang_v1.emi'),'bkash'=> __('lang_v1.bkash'), 'other' => __('lang_v1.other')];
